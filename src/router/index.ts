...
export const asyncRouterMap: AppRouteRecordRaw[] = [
  ...
  // },
  {
    ...
    children: [
      {
        path: 'qne',
        component: () => import('@/views/Invoice/QnE.vue'),
        name: 'QnE',
        meta: {
          title: 'QnE',
          noCache: true,
      ...
      {
        path: 'qnedo',
        component: () => import('@/views/Invoice/QnEDO.vue'),
        name: 'QnEDO',
        meta: {
          title: 'QnEDO',
          noCache: true
      ...
      {
        path: 'mdlz',
        component: () => import('@/views/Invoice/Mdlz.vue'),
        name: 'Mdlz',
        meta: {
          title: 'Mdlz',
          noCache: true
      ...
      {
        path: 'mdlzdo',
        component: () => import('@/views/Invoice/MdlzDO.vue'),
        name: 'MdlzDO',
        meta: {
          title: 'MdlzDO',
          noCache: true
      ...
      {
        path: 'lipton',
        component: () => import('@/views/Invoice/Lipton.vue'),
        name: 'Lipton',
        meta: {
          title: 'Lipton',
          noCache: true
      ...
      {
        path: 'invoicesummary',
        component: () => import('@/views/Invoice/InvoiceSummary.vue'),
        name: 'InvoiceSummary',
        meta: {
  ...
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/TruckLoading/TruckLoading.vue'),
        name: 'TruckLoading',
        meta: {
          title: t('router.truckLoading'),
  ...
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/DeliveryStatus/DeliveryStatus.vue'),
        name: 'DeliveryStatus',
        meta: {
          title: t('router.deliveryStatus'),
  ...
  // },
  {
    ...
    children: [
      {
        path: 'mhc',
        component: () => import('@/views/Warehouse/MHC.vue'),
        name: 'MHC',
        meta: {
          title: 'MHC'
        }
      ...
      {
        path: 'mha',
        component: () => import('@/views/Warehouse/MHA.vue'),
        name: 'MHA',
        meta: {
          title: 'MHA'
        }
      ...
      {
        path: 'mh3',
        component: () => import('@/views/Warehouse/MH3.vue'),
        name: 'MH3',
        meta: {
          title: 'MH3'
        }
  ...
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/CommissionReport/CommissionReport.vue'),
        name: 'CommissionReport',
        meta: {
  ...
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/CustomerData/CustomerData.vue'),
        name: 'CustomerData',
        meta: {
          title: t('router.customerdata'),
          icon: 'vi-cil:people'
        }
      }
    ]
